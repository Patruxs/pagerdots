...
const MODES = [
    ...
    { id: "runway",  name: "Runway",  description: "Lights come on one after another along the row ahead of the dot, and go out as it passes over each of them" },
    ...
    { id: "skip",    name: "Skip",    description: "Skips across like a stone on water, each bounce lower than the last" },
    ...
    { id: "blink",   name: "Blink",   description: "Closes to a thin line like an eye shutting, and opens again on the new desktop" },
    { id: "wipe",    name: "Wipe",    description: "A curtain sweeps along the row, wiping the dot off the old desktop and painting it onto the new one" },
